...
export default function EditorContainer() {
    const { tabs, activeTabId, updateTab, settings, recentFiles, openFile } = useEditorStore();
    const activeTab = tabs.find((t) => t.id === activeTabId);

    // Auto-save logic
    useEffect(() => {
        if (!settings.autoSave || !activeTab || !activeTab.isDirty || !activeTab.filepath) return;
    ...
    }, [activeTab, settings.autoSave, updateTab]);
